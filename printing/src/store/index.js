...
export default new Vuex.Store({
  ...
  actions: {
    ...
    getCompletedWorks({
      ...
      axios.get(`${this.state.apiPath}/api/getCompletedWorks?lang=${this.state.storage.locale}`).then((response) => {
    ...
    getCompletedWorkById({
      ...
      return new Promise((resolve, reject) => {
        axios.get(`${this.state.apiPath}/api/getCompletedWorkById?id=${id}lang=${this.state.storage.locale}`).then(response => {
